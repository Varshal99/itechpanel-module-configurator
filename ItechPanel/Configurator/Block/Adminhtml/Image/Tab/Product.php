...
namespace ItechPanel\Configurator\Block\Adminhtml\Image\Tab;
...
class Product extends Extended
{
    ...
    public function getGridUrl() { return $this->getUrl('configurator/image/productsgrid', ['_current' => true]); }
}